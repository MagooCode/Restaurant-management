...
public class MealSetServiceImpl implements MealSetService {
    ...
    public String saveMealSet(CreateMealSetRequest createMealSetRequest) {
        ...
        MealSet mealSet = MEAL_SET_MAPPER.mapToEntity(createMealSetRequest);
        ...
        if(totalPrice<0 || createMealSetRequest.getDiscount()<0){
            throw new InsufficientTotalPriceException("Please enter discount and total price correctly");
        }
    ...
    public String updateMealSet(Long mealSetId, UpdateMealSetRequest updateMealSetRequest) {
        ...
        MealSet updatedMealSet = MEAL_SET_MAPPER.mapToEntityToUpdate(mealSetToUpdate, updateMealSetRequest);
